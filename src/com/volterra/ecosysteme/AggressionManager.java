...
public class AggressionManager {
   ...
   *
   * @param assailant The assailant Tribe
   * @param victim The victim Tribe
   */
   ...
   *
   * @param tribe Tribe that will be tested
   * @return Whether the test is successfull or not
   */
   ...
   *
   * @param aggression Aggression to reset
   */
   ...
   *
   * @param aggression Aggression to set
   */
   ...
   * If one group is completely dead, the remaining group gain some bonus defined in <i>postFightModifications</i>
   *
   * @param aggression Aggression to set
  ...
  /**
   * Updates fight states for an aggression
   * @param aggression Aggression to set
   */
   ...
   *
   * @param tribes Tribes that will be affected by modifications
   */
