...
public class Aggression {
  ...
  /**
   * Current state of the aggression
   */
   ...
   *
   * @return current state of the aggression
   */
   ...
   */
  public Tribe getFirstAssailant() {
    return assailants.get(0);
  }

  /**
   * Add a new tribe to the assailants
   *
   * @param tribe Tribe attacking the same victims
   */
  ...
  /**
   * Return the victims of the aggression
   *
   * @return victims of the aggression
   */
   ...
   *
   * @param tribe Tribe that is being aggressed
   */
   ...
   *
   * @return The max duration of an aggression
   */
   ...
   *
   * @param tribe Tribe being targeted
   */
